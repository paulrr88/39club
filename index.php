...
<body>
    ...
    <div class="container" style="background: purple;">
      ...
      <header class="header-skew" role="banner"><!--Start of header area containing website title, graphics and navigation etc-->
        ...
        <img class="fluid-half left" src="img/logo.png" style="background: pink;" />
