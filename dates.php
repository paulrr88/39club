...
<head>
  ...
  <meta name="description" content="Schedule of club times and dates, events etc for your diary!">
...
<body>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <main class="container clear overflow-hidden"><!--Container for ALL content, everything inside this-->
        <h1 class="content-title-top content-title-pagetop" role="heading">Times &amp; Dates</h1>
        
        <article class="content">
            <div class="content-row row">
                <section class="bold ten columns offset-by-one textmid3" role="main">
                    
                    <table aria-label="Schedule of club dates" class="table" summary="Table of upcoming dates">
